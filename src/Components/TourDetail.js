...
class TourDetail extends React.Component {
  ...
  get tourDetail() {
    return this.props.stores.tourStore.tourDetail();
  }
  ...
  loadTourDetail = () => {
    ...
    this.props.stores.tourStore.loadTourDetail(tourId);
  };
  render() {
    const date = new Date();
    const dateFormat =
    ...
    const { tourDetail } = this;
    const user = { ...tourDetail.user };

    return (
      <div>
        <Carousel className="carousel">
          {tourDetail.images.map((picture) => {
            return (
            ...
            <div class="row justify-content-center">
              <div class="col-lg-8 col-md-9">
                ...
                <div class="destination_info">
                  <h3>Description</h3>
                  <div class="single_destination">{tourDetail.description}</div>
                </div>
...
export default inject("stores")(withRouter(observer(TourDetail)));
